...
Traceback (most recent call last):
  ...
  File "E:\Josef\eclipsegworkspace\gwstatsmodels-josef-experimental-030\scikits\gwstatsmodels\sandbox\distributions\try_pot.py", line 35, in mean_residual_life
    for i in range(len(xthreshold)-1):
