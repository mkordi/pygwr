...
if __name__ == '__main__':
    ...
    Traceback (most recent call last):
      File "C:\Josef\eclipsegworkspace\gwstatsmodels-josef-experimental-gsoc\scikits\gwstatsmodels\sandbox\regression\test_numdiff.py", line 74, in <module>
        print 'fd', numdiff.approx_hess(test_params, loglike, epsilon)
      File "C:\Josef\eclipsegworkspace\gwstatsmodels-josef-experimental-gsoc\scikits\gwstatsmodels\sandbox\regression\numdiff.py", line 118, in approx_hess
        xh = x + h
