...
Traceback (most recent call last):
  File "C:\...\scikits\gwstatsmodels\sandbox\cox.py", line 244, in <module>
    res = c.newton([0.4])
...
from gwstatsmodels.base import model
import survival
...
if __name__ == '__main__':
    ...
    import gwstatsmodels.sandbox.formula as F
    x = F.Quantitative('X')
    f = F.Formula(x)
...
#    c.cache()
    ...
    Traceback (most recent call last):
      File "<pyshell#1>", line 1, in <module>
        c.fit()
      File "C:\Josef\eclipsegworkspace\gwstatsmodels-josef-experimental\scikits\gwstatsmodels\model.py", line 132, in fit
    ...
    Traceback (most recent call last):
      File "<pyshell#2>", line 1, in <module>
        c.fit([0.4])
      File "C:\Josef\eclipsegworkspace\gwstatsmodels-josef-experimental\scikits\gwstatsmodels\model.py", line 148, in fit
        H = self.hessian(history[-1])
      File "C:\Josef\eclipsegworkspace\gwstatsmodels-josef-experimental\scikits\gwstatsmodels\model.py", line 115, in hessian
    ...
    <gwstatsmodels.model.LikelihoodModelResults object at 0x01D48B70>
    >>> res=c.fit([0.4],method="bfgs")
    Optimization terminated successfully.
             Current function value: 802.354181
             Iterations: 3
