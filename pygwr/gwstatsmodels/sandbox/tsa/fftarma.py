...
from gwstatsmodels.sandbox.archive.linalg_decomp_1 import OneTimeProperty
from gwstatsmodels.tsa.arima_process import ArmaProcess
...
class ArmaFft(ArmaProcess):
    ...
    def filter2(self, x, pad=0):
        ...
        '''
        from gwstatsmodels.tsa.filters import fftconvolve3
        if not pad:
            pass
        elif pad == 'auto':
