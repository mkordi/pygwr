...
import gwstatsmodels.robust.norms as norms
import gwstatsmodels.robust.scale as scale
...
class RLM(base.LikelihoodModel):
    ...
    M : gwstatsmodels.robust.norms.RobustNorm, optional
        ...
        See gwstatsmodels.robust.norms for more information.
    ...
    **Attributes**
    ...
    exog : array
        ...
        data is already an array and it is changed, then `endog` changes
        as well.
    M : gwstatsmodels.robust.norms.RobustNorm
...
class RLMResults(base.LikelihoodModelResults):
    ...
    **Attributes**
    ...
    See also
    --------
    gwstatsmodels.model.LikelihoodModelResults
    """
    ...
    def summary(self, yname=None, xname=None, title=0, alpha=.05,
        ...
        """
        from gwstatsmodels.iolib.summary import (summary_top,
