...
class RobustNorm(object):
    ...
    See Also
    --------
    gwstatsmodels.rlm for more information on how the estimators are used
    ...
    def psi_deriv(self, z):
        ...
        See gwstatsmodels.rlm for more information.
...
class LeastSquares(RobustNorm):
    ...
    See also
    --------
    gwstatsmodels.robust.norms.RobustNorm for the methods.
    """
...
class HuberT(RobustNorm):
    ...
    See also
    --------
    gwstatsmodels.robust.norms.RobustNorm
    """
