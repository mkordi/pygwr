...
import gwstatsmodels.tsa.base.tsa_model as tsbase
import gwstatsmodels.base.wrapper as wrap
from gwstatsmodels.regression.linear_model import yule_walker, GLS
from gwstatsmodels.tsa.tsatools import (lagmat, add_trend,
        _ar_transparams, _ar_invtransparams, _ma_transparams,
        _ma_invtransparams)
from gwstatsmodels.tsa.vector_ar import util
from gwstatsmodels.tsa.ar_model import AR
from gwstatsmodels.tsa.arima_process import arma2ma
from gwstatsmodels.sandbox.regression.numdiff import (approx_fprime,
        approx_fprime_cs, approx_hess, approx_hess_cs)
from gwstatsmodels.tsa.kalmanf import KalmanFilter
...
class ARMA(tsbase.TimeSeriesModel):
    ...
    def fit(self, order, start_params=None, trend='c', method = "css-mle",
        ...
        Returns
        -------
        `gwstatsmodels.tsa.arima.ARMAResults` class

        See also
        --------
        gwstatsmodels.model.LikelihoodModel.fit for more information
        ...
        `gwstatsmodels.LikelihoodModel.fit`
        """
