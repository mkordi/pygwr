...
#            for i in xrange(int(nobs)):
    ...
    def loglike(cls, params, arma_model):
        ...
        arma_model : `gwstatsmodels.tsa.arima.ARMA` instance
...
# Examples from Durbin and Koopman
    import zipfile
    try:
        dk = zipfile.ZipFile('/home/skipper/gwstatsmodels/gwstatsmodels-skipper/scikits/gwstatsmodels/sandbox/tsa/DK-data.zip')
    except:
