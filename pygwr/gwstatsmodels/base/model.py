...
from gwstatsmodels.base.data import handle_data
from gwstatsmodels.tools.tools import recipr
from gwstatsmodels.stats.contrast import ContrastResults
...
class LikelihoodModelResults(Results):
    ...
    **Attributes**
    ...
    def f_test(self, r_matrix, q_matrix=None, cov_p=None, scale=1.0,
        ...
        See also
        --------
        gwstatsmodels.contrasts
        gwstatsmodels.model.t_test
    ...
    def save(self, fname, remove_data=False):
        ...
        from gwstatsmodels.iolib.smpickle import save_pickle
    ...
    def load(cls, fname):
        ...
        from gwstatsmodels.iolib.smpickle import load_pickle
