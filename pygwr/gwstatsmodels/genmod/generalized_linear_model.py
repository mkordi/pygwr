...
import numpy as np
import families
from gwstatsmodels.tools.tools import rank
from gwstatsmodels.tools.decorators import (cache_readonly,
        resettable_cache)

import gwstatsmodels.base.model as base
import gwstatsmodels.regression.linear_model as lm
import gwstatsmodels.base.wrapper as wrap

from scipy.stats import t
from gwstatsmodels.tools.sm_exceptions import PerfectSeparationError
...
class GLM(base.LikelihoodModel):
    ...
    GLM inherits from gwstatsmodels.LikelihoodModel
    ...
    family : family class instance
        ...
        gwstatsmodels.family.family for more information.
    ...
    **Attributes**
    ...
    family : family class instance
        ...
        gwstatsmodels.families.  Default is Gaussian.
    mu : array
        ...
        gwstatsmodels.families.family.fitted of the distribution family for more
        information.
    normalized_cov_params : array
    ...
    weights : array
        ...
        available after fit is called.  See gwstatsmodels.families.family for
    ...
    def loglike(self, *args):
        ...
        See gwstatsmodels.families.family
        """
    ...
    def estimate_scale(self, mu):
        ...
        See also
        --------
        gwstatsmodels.glm.fit for more information
        """
    ...
    def fit(self, maxiter=100, method='IRLS', tol=1e-8, data_weights=1., 
        ...
        if np.shape(self.data_weights) == ():
            self.data_weights *= np.ones((self.exog.shape[0]))
...
class GLMResults(base.LikelihoodModelResults):
    ...
    GLMResults inherits from gwstatsmodels.LikelihoodModelResults

    Parameters
    ----------
    See gwstatsmodels.LikelihoodModelReesults
    ...
    **Attributes**
    ...
    deviance : float
        See gwstatsmodels.families.family for the distribution-specific deviance
        functions.
    df_model : float
        See GLM.df_model
    df_resid : float
    ...
    llf : float
        ...
        See gwstatsmodels.families.family for distribution-specific loglikelihoods.
    ...
    resid_anscombe : array
        Anscombe residuals.  See gwstatsmodels.families.family for distribution-
        specific Anscombe residuals.
    resid_deviance : array
        Deviance residuals.  See gwstatsmodels.families.family for distribution-
    ...
    resid_pearson : array
        ...
        specific variance function.  See gwstatsmodels.families.family and
        gwstatsmodels.families.varfuncs for more information.
    resid_response : array
        Respnose residuals.  The response residuals are defined as
        `endog` - `fittedvalues`
    resid_working : array
        Working residuals.  The working residuals are defined as
        `resid_response`/link'(`mu`).  See gwstatsmodels.family.links for the
    ...
    See Also
    --------
    gwstatsmodels.LikelihoodModelResults
    '''
    ...
    @cache_readonly
    def pseudo_r2(self):
        return 1. - (self.llf / self.null_llf)
    
    # @cache_readonly
    # def pseudo_r2(self):
    #     null_model = GLM(
    #         endog = self._endog,
    #         exog = np.ones(len(self._endog))
    #     )
    #     null_model_result = null_model.fit()
    #     return 1. - (self.llf / null_model_result.llf)
