...
#[<gwstatsmodels.family.links.Log object at 0x9a4240c>,
# <gwstatsmodels.family.links.Power object at 0x9a423ec>,
# <gwstatsmodels.family.links.Power object at 0x9a4236c>]
# for Poisson...
        self._link = link
...
#            validlink = max([isinstance(link, _.__class__) for _ in self.links])
    ...
    def resid_anscombe(self, Y, mu):
        ...
        See also
        --------
        gwstatsmodels.families.family.Family docstring and the `resid_anscombe` for
...
class Poisson(Family):
    ...
    link : a link instance, optional
        ...
        links are log, identity, and sqrt. See gwstatsmodels.family.links for
        more information.
    ...
    Poisson.variance : varfuncs instance
        ...
        gwstatsmodels.genmod.families.family.varfuncs.mu

    See also
    --------
    gwstatsmodels.genmod.families.family.Family
    """
...
class Gaussian(Family):
    ...
    link : a link instance, optional
        ...
        See gwstatsmodels.family.links for more information.
    ...
    Gaussian.variance : varfunc instance
        `variance` is an instance of gwstatsmodels.family.varfuncs.constant
...
class Gamma(Family):
    ...
    Gamma.variance : varfunc instance
        `variance` is an instance of gwstatsmodels.family.varfuncs.mu_squared
...
class Binomial(Family):
    ...
    Binomial.variance : varfunc instance
        `variance` is an instance of gwstatsmodels.family.varfuncs.binary
...
class InverseGaussian(Family):
    ...
    InverseGaussian.variance : varfunc instance
        `variance` is an instance of gwstatsmodels.family.varfuncs.mu_cubed
...
class NegativeBinomial(Family):
    ...
    NegativeBinomial.variance : varfunc instance
        `variance` is an instance of gwstatsmodels.family.varfuncs.nbinom
