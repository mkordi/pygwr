...
from gwstatsmodels.tools.tools import (add_constant, rank,
                                             recipr, chain_dot)
...
def yule_walker(X, order=1, method="unbiased", df=None, inv=False, demean=True):
    ...
    --------
    >>> import gwstatsmodels.api as sm
    >>> from gwstatsmodels.datasets.sunspots import load
    >>> data = load()
...
#        See mailing list discussion October 17,
    ...
    def summary(self, yname=None, xname=None, title=None, alpha=.05):
        ...
        from gwstatsmodels.stats.stattools import (jarque_bera,
...
class OLSResults(RegressionResults):
    ...
    def get_influence(self):
        ...
        '''
        from gwstatsmodels.stats.outliers_influence import OLSInfluence
