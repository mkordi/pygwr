...
if __name__ == '__main__':
    data = np.load(r"E:\Josef\eclipsegworkspace\gwstatsmodels-josef-experimental-030\dist\gwstatsmodels-0.3.0dev_with_Winhelp_a2\gwstatsmodels-0.3.0dev\scikits\gwstatsmodels\tsa\vector_ar\tests\results\vars_results.npz")
