...
import gwstatsmodels.tools.tools as tools
...
class DiscreteModel(base.LikelihoodModel):
    ...
    gwstatsmodels.model.LikelihoodModel.
    """
    ...
    def initialize(self):
        ...
        gwstatsmodels.model.LikelihoodModel.__init__
...
#                        approx_grad=True)
    ...
    from gwstatsmodels.sandbox.regression.numdiff import approx_hess_cs
